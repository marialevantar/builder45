...
<div class="content-wrapper">
  ...
  <form id="addcustomer" method="post" action="<?php echo base_url(); ?>billing/savesale/">
...
Phone: (555) 555-5555</textarea>
            ...
            <div id="company_name">
              <?php echo $boutiquedetails['boutique_name'];?> <br>
   ...
   <div class="col-md-3" id="hiderow">    
    ...
    <table id="items" class="table-responsive table">
		...
		<br>
    <br>
		<input type="submit" class="btn btn-primary" id="hiderow" value="add">
