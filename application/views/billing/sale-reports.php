      ...
      <div class="col-xs-12">
                <div class="box">
                  <div class="box-header">
                    <h3 class="box-title">All Income List</h3><br><br>
                  </div>
                  <!-- /.box-header -->
           <div class="box-body">
                     ...
                     <?php 
                      ...
                      for($i = 0; $i < $total; $i++) { ?>
                        <tr>
                         ...
                         <td><a href="<?php echo base_url(); ?>boutique/incomecate_property/<?php echo $expences[$i]["boutique_property_id"]; ?>"><?php echo $expences[$i]["boutique_property_name"]; ?></a></td>
