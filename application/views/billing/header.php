...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      if($this->session->userdata('UserRole') == 2 )
      {
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-circle-o text-orange"></i> <span>Project Management</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-circle-o text-orange"></i> <span>Stock List</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
 ...
 <li class="active"><a href="<?php echo base_url(); ?>billing/add_credit_item"><i class="fa fa-circle-o"></i>Add Credit Item</a></li>
        ...
        <!--</li>-->
                 <!--<li class="treeview">-->
                 <!--             <a href="#">-->
                 <!--               <i class="fa fa-circle-o text-orange"></i> <span>Asset Transfer Request</span>-->
                 <!--               <span class="pull-right-container">-->
                 <!--                 <i class="fa fa-angle-left pull-right"></i>-->
                 <!--               </span>-->
                 <!--             </a>-->
