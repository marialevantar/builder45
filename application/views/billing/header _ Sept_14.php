...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/tagsly.css">
  <style>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url(); ?>boutique/dashboard" class="logo">
      ...
      <span class="logo-mini"><b>Site Manager</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Site Manager</span>
    </a>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p><?php echo $this->session->userdata('BoutiqueName');?></p>
        </div>
      </div>
      ...
      if($this->session->userdata('UserRole') == 3 )
      {
        ?>
              <!-- Project -->
        <!-- <li>
          <a href="<?php echo base_url(); ?>boutique/userprojects">
            <i class="fa fa-circle-o text-orange"></i> <span>Assigned Projects</span>
          </a>
        </li>

        <li class="treeview">
          <a href="#">
            <i class="fa fa-circle-o text-orange"></i> <span>Leave </span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url(); ?>boutique/applyleave"><i class="fa fa-circle-o"></i>Apply Leave</a></li>
            <li class="active"><a href="<?php echo base_url(); ?>boutique/listleave"><i class="fa fa-circle-o"></i>List Leave</a></li>           
          </ul>
        </li>   -->
...
<li class="treeview">
          <a href="#">
            <i class="fa fa-circle-o text-orange"></i> <span>Payment</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <!-- <li class="active"><a href="<?php echo base_url(); ?>boutique/applyleave"><i class="fa fa-circle-o"></i>Apply Leave</a></li> -->
            <li class="active"><a href="<?php echo base_url(); ?>boutique/apply_payment_request"><i class="fa fa-circle-o"></i>Apply Request</a></li>

            <li class="active"><a href="<?php echo base_url(); ?>boutique/list_payment_request"><i class="fa fa-circle-o"></i>List Request</a></li>           
          </ul>
        </li> 
        <?php
        }
      ?>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="<?php echo base_url(); ?>boutique/siteattendance"><i class="fa fa-circle-o"></i>Attendance</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          <a href="#">
            <!-- <i class="fa fa-circle-o text-orange"></i> <span>Leave Application </span> -->
            <i class="fa fa-circle-o text-orange"></i> <span>Payment</span>
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url(); ?>boutique/payment_requests"><i class="fa fa-circle-o"></i>Requests</a></li>
          </ul>
        </li>  
        <?php } ?>
        <!-- Accounts -->
        ...
        <?php 
        if($this->session->userdata('UserRole') == 2 || $this->session->userdata('UserRole') == 4  || $this->session->userdata('UserRole') == 5  || $this->session->userdata('UserRole') == 6 || $this->session->userdata('UserRole') == 7 ){
        ?>
        
        <li class="treeview">
          <a href="#">
            <i class="fa fa-circle-o text-orange"></i> <span>Accounts</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          ...
          <?php if($this->session->userdata('UserRole') == 4 ||  $this->session->userdata('UserRole') == 5  || $this->session->userdata('UserRole') == 6  || $this->session->userdata('UserRole') == 2 || $this->session->userdata('UserRole') == 7 ){  ?>
       ...
       <?php } ?>
          ...
          <?php 
        if($this->session->userdata('UserRole') == 2 || $this->session->userdata('UserRole') == 5  || $this->session->userdata('UserRole') == 6 || $this->session->userdata('UserRole') == 7 ){
        ?>
      <li class="treeview">
          <a href="#">
            <i class="fa fa-circle-o text-orange"></i> <span>Project Estimation</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
        ...
        <?php } ?>
        <!-- <li class="header">Project Planning & Monitoring</li> -->
        <?php 
        if($this->session->userdata('UserRole') == 2 || $this->session->userdata('UserRole') == 6 ){
        ?>
        <li class="treeview">
          <a href="#">
            <i class="fa fa-circle-o text-orange"></i> <span>Project Planning</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
        ...
        <?php } ?>
        <!-- <li class="header">Items In Store</li> -->
       
        <?php 
        if($this->session->userdata('UserRole') == 2 || $this->session->userdata('UserRole') == 4 ){
        ?>
        <li class="treeview">
          <a href="#">
            <i class="fa fa-circle-o text-orange"></i> <span>Items In Store</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
      ...
      <li class="active"><a href="<?php echo base_url(); ?>billing/add_credit_item"><i class="fa fa-circle-o"></i>Add Credit Item</a></li>
        ...
        if($this->session->userdata('UserRole') == 2){
        ?>
        <!-- <li class="header">Staff Logins</li> -->
        <li class="treeview">
          <a href="#">
            <i class="fa fa-circle-o text-orange"></i> <span>Staff Logins</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="<?php echo base_url(); ?>billing/creditlistreport"><i class="fa fa-circle-o"></i>Credit Item Reports</a></li>
            <!-- <li class="active"><a href="<?php echo base_url(); ?>billing/gstreport"><i class="fa fa-circle-o"></i>GST Reports</a></li> -->
            <li class="active"><a href="<?php echo base_url(); ?>billing/profitreport"><i class="fa fa-circle-o"></i>Cash Book</a></li>
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-circle-o text-orange"></i> <span>Petty Cash Reports</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url(); ?>billing/pettycashreport"><i class="fa fa-circle-o"></i>Petty Cash Reports</a></li>
 
            <li class="active"><a href="<?php echo base_url(); ?>boutique/pettycashlist"><i class="fa fa-circle-o"></i>Petty Cash List</a></li>
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-circle-o text-orange"></i> <span>Office</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url(); ?>boutique/userlist_others"><i class="fa fa-circle-o"></i>Users</a></li>
