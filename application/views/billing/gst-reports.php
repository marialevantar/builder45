                     ...
                     <?php 
                      ...
                      for($i = 0; $i < $total; $i++) { ?>
                        <tr>
                          ...
                          <td><a href="<?php echo base_url(); ?>billing/addsale/<?php echo $sale[$i]["boutique_sale_id"]; ?>" target="_blank"><?php echo $sale[$i]["boutique_sale_invoice_gstnumber"]; ?></a></td>
                          <td><?php echo $sale[$i]["boutique_item_names"]; ?></td>
