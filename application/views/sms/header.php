...
<head>
  ...
  <title>Boutique 1 | Dashboard</title>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
         ...
         <?php if($this->session->userdata('BoutiqueStitchingStatus') == 1 && $this->session->userdata('UserRole') != 6){?>
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-circle-o text-orange"></i> <span><?php echo (($this->session->userdata('BoutiqueID') == 27) || ($this->session->userdata('BoutiqueID') == 51) || ($this->session->userdata('BoutiqueID') == 52)) ? 'Staffs' : (($this->session->userdata('BoutiqueID') == 33) ? "Staffs" : "Tailors") ; ?></span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url(); ?>boutique/tailor"><i class="fa fa-circle-o"></i><?php echo (($this->session->userdata('BoutiqueID') == 27) || ($this->session->userdata('BoutiqueID') == 51) || ($this->session->userdata('BoutiqueID') == 52)) ? 'Staffs' : (($this->session->userdata('BoutiqueID') == 33) ? "Staffs" : "Tailors") ; ?> List</a></li>
            <li class="active"><a href="<?php echo base_url(); ?>boutique/addtailor"><i class="fa fa-circle-o"></i>Add <?php echo (($this->session->userdata('BoutiqueID') == 27) || ($this->session->userdata('BoutiqueID') == 51 || ($this->session->userdata('BoutiqueID') == 52))) ? 'Staff' : (($this->session->userdata('BoutiqueID') == 33) ? "Staff" : "Tailor") ; ?></a></li>
        ...
        <?php if($this->session->userdata('UserRole') == 4){?> 
          <li class="treeview">
          <a href="#">
            <i class="fa fa-circle-o text-orange"></i> <span>Settings</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
        ...
        <?php if($this->session->userdata('BoutiqueBillingStatus') == 1 && $this->session->userdata('UserRole') != 6){?>
