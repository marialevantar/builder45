...
<div class="content-wrapper">
  ...
  <div class="box box-info">
    <form id="addcustomer" method="post" action="<?php echo base_url(); ?>boutique/updatesheduledwork/">
      <div class="box-header with-border">
        <h3 class="box-title">Work Details</h3>
        <span class="pull-right"><a class="btn btn-info" href="<?php echo base_url(); ?>boutique/listschedulework">
        Back</a></span>
      </div>
      <div class="box-body">
        <div class="row">
         ...
         -->
          <div class="col-md-12">
            <div class="form-group">
              ...
              <textarea name="actual_work" class="form-control" rows="3" disabled><?php echo $schedulework[0]["schedule_work_actualwork"]; ?></textarea>
         </div>
          </div>
          ...
          <div class="col-md-12">
            <div class="form-group">
              <label>Remarks</label>
              <textarea name="task" class="form-control" rows="3" disabled><?php echo $schedulework[0]["schedule_work_task"]; ?></textarea>
         </div>
          </div>
          ...
          <div class="col-md-12">
            <div class="form-group">
              ...
              <textarea name="comments" class="form-control" rows="3"><?php echo $schedulework[0]["scheduled_work_builders_comments"]; ?></textarea>
         </div>
          </div>
