...
<div class="content-wrapper">
  ...
  <div class="box box-info">
    <form id="addcustomer" method="post" action="<?php echo base_url(); ?>boutique/updateexpence/">
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  for($i=0; $i<count($properties);$i++) {
                   ?>
                    <option value="<?php echo $properties[$i]['boutique_property_id']; ?>" <?php if($properties[$i]['boutique_property_id']==$expences['boutique_property']) echo 'selected'; ?>>
