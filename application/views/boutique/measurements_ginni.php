                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12">
                        ...
                        <div class="row">
                          ...
                          <div class="col-xs-12 col-sm-1">
                           <input class="form-control" type="text" name="mt1_m_cotton_1" value="<?php echo @$measurement['mt1_m_cotton_1']; ?>"/>
                          </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-xs-12 col-sm-1">
                            <input class="form-control" type="text" name="mt1_m_waist_2" value="<?php echo @$measurement['mt1_m_waist_2']; ?>"/>
                          </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-xs-12 col-sm-1">
                            <input class="form-control" type="text" name="mt1_s_short_sleeves" value="<?php echo @$measurement['mt1_s_short_sleeves']; ?>"/>
                          </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-xs-12 col-sm-1">
                            <input class="form-control" type="text" name="mt1_m_waist_3" value="<?php echo @$measurement['mt1_m_waist_3']; ?>"/>
                          </div>
                    ...
                    <div class="col-xs-12 col-sm-12">
                      <div class="row">
                        ...
                        <div class="row">
                          ...
                          <div class="col-xs-12 col-sm-3">
                            <input class="form-control" type="text" name="mt1_l_waist_4" value="<?php echo @$measurement['mt1_l_waist_4']; ?>"/>
                          </div>
