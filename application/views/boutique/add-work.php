        ...
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input name="price" id="price" type="text" class="form-control" value="<?php echo $cust['tenants_room_rent'];?>">
              </div>
            </div>
          </div>
          ...
          <div class="col-md-12">
            <div class="form-group">
              ...
              <div class="input-group">
                <span class="input-group-addon"><span class="fa-inr fa"></span></span>
                <input name="price_tdf" type="text" class="form-control" value="<?php echo @$teamdetail->TeamPhone; ?>">
              </div>
            </div>
          </div>
          ...
          <div class="col-md-12">
            <div class="form-group">
              ...
              <div class="input-group">
                <span class="input-group-addon"><span class="fa-inr fa"></span></span>
                <input name="discount" type="text" class="form-control" value="<?php echo @$teamdetail->TeamPhone; ?>">
              </div>
            </div>
          </div>
          ...
          <div class="col-md-12">
            <div class="form-group">
              ...
              <div class="input-group date"">
                <span class="input-group-addon"><span class="fa-inr fa"></span></span>
                <input name="month_name" type="text" class="form-control" value="<?php echo @$teamdetail->TeamPhone; ?>">
              </div>
            </div>
          </div>
          <div class="col-md-12">
            <div class="form-group">
              ...
              <div class="input-group date">
                ...
                <input name="rent_to_date" type="text" class="form-control pull-right" id="datepicker2">
              </div>
            </div>
          </div>
