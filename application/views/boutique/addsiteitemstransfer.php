      ...
      <div id="page-wrap">
        ...
        <div class="col-md-12">
            <div class="form-group">
              <label>Date</label>
              <input name="date" type="text" id="datepicker" class="form-control" value="">
            </div>
          </div>
    ...
    <div class="col-md-6" id="hiderow">    
        <div class="form-group">
              <div class="input-group">
                ...
                <input class="form-control mousetrap ui-autocomplete-input" placeholder="Enter Item" autofocus="" name="search_product" type="text" autocomplete="off" name="sku" id="sku">
