                    ...
                    <table id="example2" class="table table-bordered table-striped">
                      ...
                      <tbody>
                        <?php foreach($leave as $lea){ ?>
                          ...
                          <td><?php echo $lea["builder_leave_apply_date"]; ?></td>
                                <td><?php 
                                if($lea["builder_leave_apply_status"] == 1)
                                {
                                    ?>
                               <a style="color:blue" href="<?php echo base_url(); ?>boutique/update_admin_leave/<?php echo $lea["builder_leave_apply_id"]; ?>"><?php  echo $lea["boutique_user_username"]; ?></a> 
                                ...
                                <td><?php echo $lea["builder_leave_apply_office_commment"]; ?></td>
                                    <td>
                                       <a class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this expence ?');"  href="<?php echo base_url(); ?>boutique/remove_delete/<?php echo $lea["builder_leave_apply_id"]; ?>"><i class="fa fa-trash"></i></a> 
                                    </td>
                              </tr>
                        <?php } ?>
                    </tbody>
