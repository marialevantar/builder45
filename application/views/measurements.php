      ...
      <div class="col-xs-12">
                <div class="box">
                  <div class="box-header">
                    ...
                    <span><a class="btn btn-info" href="<?php echo base_url(); ?>admin/addmeasurement">Add Measurement</a></span>
                  </div>
                  <!-- /.box-header -->
                  <div class="box-body">
                    <table id="example1" class="table table-bordered table-striped">
                      ...
                      <tbody>
                      <tr><td><a href="<?php echo base_url(); ?>admin/measurementdetails/1">Shoulder</a></td><td></td></tr>
                      <?php 
                      /*
